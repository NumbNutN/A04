...
# class2df = pd.DataFrame(data)
# subclass2df = class2df.sample(n=2000)
...
df = pd.DataFrame(data)
df = df.sort_values(by='label',ascending=True)
df.to_csv("./data/all_content_strenghen_5_18.csv",sep=',',mode='w',header=False,index=False,encoding='utf-8')
