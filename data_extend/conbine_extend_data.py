...
word_set_list, label_list = fet.new_normalization_word_number(word_set_list,label_list,specifiedWordNum=200,thresholdWordNum=50)
print("归一化完成")
...
df.to_csv("./data/all_content.csv",sep=',',mode='w',header=False,index=False,encoding='utf-8')
